...
path = "/Users/huang/Downloads/SqueezeNet-master/dataset/tiny-imagenet-200/"
...
data =[]
with open("/Users/huang/Downloads/SqueezeNet-master/dataset/tiny-imagenet-200/val/val_annotations.txt") as f:
    data = f.readlines()
