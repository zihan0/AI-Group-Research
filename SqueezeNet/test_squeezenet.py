...
def test(sq_net,test_files,labels):
    with tf.Session() as sess:
        ...
        saver_v0.restore(sess,model_dir+"v0_15/")
        saver_v0_res.restore(sess,model_dir+"v0_res_15/")
        saver_v1.restore(sess,model_dir + "v1_15/")
        ...
        for i in range(len(test_files)):
            ...
            #print ("img = %r pred_v0 = %r, %r pred_v0_res = %r, %r pred_v1 = %r, %r" %
             #      (i,pred_v0,labels[pred_v0],pred_v0_res,labels[pred_v0_res],pred_v1,labels[pred_v1]))
...
data_path = "/Users/huang/Downloads/SqueezeNet-master/dataset/tiny-imagenet-200/train/"
#path of labels for tiny imagenet 
file_path = "/Users/huang/Downloads/SqueezeNet-master/dataset/tiny-imagenet-200/words.txt"
#path of testing data 
test_files = glob("/Users/huang/Downloads/SqueezeNet-master/dataset/tiny-imagenet-200/test/images/*.JPEG")
...
labels = get_labels(data_path,file_path)
